...
<body>
	<article>
		<header>
			<div class="post-date">26/08/2013 por rafa</div>
			<a href="post/2013/08/aprendiendo-groovy"><h1>Aprendiendo
					groovy</h1></a>
		</header>
		<section>
		...
		<section>
			...
			<p>Como primera referencia aconsejo siempre la documentación
				oficial:</p>
			<ul>
		...
		<footer>
			<a href="https://twitter.com/share" class="twitter-share-button"
				data-url="http://rafbermudez.com/post/2013/08/aprendiendo-groovy"
				data-text="aprendiendo-groovy" data-via="rafbermudez" data-lang="es"
				data-hashtags="groovy">Twittear</a>
			<script>
				!function(d, s, id) {
	...
	<article>
		<header>
			<div class="post-date">20/08/2013 por rafa</div>
			<a href="post/2013/08/5-maneras-de-conocer-mejor-este-blog"><h1>5
					maneras de conocer mejor este blog</h1></a>
		</header>
		<section>
		...
		<section>
			...
			<p>
				...
				localizado en <a
					href="https://github.com/rafbermudez/rafbermudez">mi
		...
		<footer>
			<a href="https://twitter.com/share" class="twitter-share-button"
				data-url="http://rafbermudez.com/post/2013/08/5-maneras-de-conocer-mejor-este-blog"
				data-text="5-maneras-de-conocer-mejor-este-blog"
				data-via="rafbermudez" data-lang="es">Twittear</a>
			<script>
				!function(d, s, id) {
					var js, fjs = d.getElementsByTagName(s)[0], p = /^http:/
							.test(d.location) ? 'http' : 'https';
	...
	<article>
		<header>
			<div class="post-date">13/08/2013 por rafa</div>
			<a href="post/2013/08/hello-world"><h1>Hello, world</h1></a>
		...
		<footer>
			<a href="https://twitter.com/share" class="twitter-share-button"
				data-url="http://rafbermudez.com/post/2013/08/hello-world"
				data-text="hello-world" data-via="rafbermudez" data-lang="es">Twittear</a>
			<script>
				!function(d, s, id) {
					var js, fjs = d.getElementsByTagName(s)[0], p = /^http:/
							.test(d.location) ? 'http' : 'https';
